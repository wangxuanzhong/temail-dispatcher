...
@Slf4j
public class DispatchCODEC {


  public static ParamEncoder getParamEncoder() {
    return ParamEncoder.ENCODER;
  }

  public static MqMsgHeaderDecoder getHeaderDecoder() {
    return MqMsgHeaderDecoder.DECODER;
  }

  public static class ParamEncoder {

    static final ParamEncoder ENCODER = new ParamEncoder();
  ...
  public static class MqMsgHeaderDecoder {

    static final MqMsgHeaderDecoder DECODER = new MqMsgHeaderDecoder();
