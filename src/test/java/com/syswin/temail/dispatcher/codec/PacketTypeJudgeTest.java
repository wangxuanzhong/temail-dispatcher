...
public class PacketTypeJudgeTest {
  ...
  public void test(){
    ...
    Assertions.assertThat(packetTypeJudge.isToBeVerifyRecieverTemail((short)(0xE), (short)0x1)).isTrue();
    Assertions.assertThat(packetTypeJudge.isToBeVerifyRecieverTemail((short)(0xE), (short)0x2)).isTrue();
    Assertions.assertThat(packetTypeJudge.isToBeVerifyRecieverTemail((short)(0xE), (short)(0x4))).isTrue();
